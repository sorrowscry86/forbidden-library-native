<script>
  ...
  import { initializeEnvironment } from '$lib/utils/tauri-detection';
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center space-x-4">
        <nav class="flex items-center space-x-6 mr-6">
          ...
          <a
            href="/planning"
            class="text-sm font-medium {$page.url.pathname === '/planning'
              ? 'text-white'
              : 'text-gray-400 hover:text-white'} transition-colors"
          >
            Planning
          ...
          {#if $environment === 'tauri'}
            <a
              href="/desktop"
              class="text-sm font-medium {$page.url.pathname === '/desktop'
                ? 'text-white'
                : 'text-gray-400 hover:text-white'} transition-colors flex items-center space-x-1"
            >
              <span>🖥️</span>
              <span>Desktop</span>
            </a>
