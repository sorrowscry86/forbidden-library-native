<script lang="ts">
  ...
  import { safeInvoke, getEnvironmentInfo } from '$lib/utils/enhanced-tauri-detection';
...
{#if $environment === 'web'}
  <div class="bg-yellow-600 text-white px-4 py-2 text-center text-sm">
    ...
    <button
      ...
      on:click={() => alert('To access full features, run: pnpm run tauri:dev')}
    >
      Install Desktop App
    </button>
  </div>
...
<!-- Debug Diagnostic Component (Development Only) -->
