...
<div class="p-2">
  {#each conversations as conversation (conversation.id)}
    <div
      class="conversation-item p-3 rounded-lg cursor-pointer transition-colors mb-2 group relative {selectedConversation?.id ===
      conversation.id
    ...
    >
      ...
      {#if conversation.archived}
        <div class="mt-2">
          <span
            class="inline-flex items-center px-2 py-1 rounded-full text-xs bg-yellow-600 text-yellow-100"
          >
